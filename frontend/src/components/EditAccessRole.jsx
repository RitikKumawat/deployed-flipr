...
import { assignRole } from '../services/operations/adminApi';
import { useNavigate } from 'react-router-dom';

const EditAccessRole = ({ isOpen, onClose,email,database }) => {
    ...
    const handleSave = () => {
        ...
        dispatch(assignRole(email,database,accessLevel,token));
        onClose();
        navigate("/");
    };
