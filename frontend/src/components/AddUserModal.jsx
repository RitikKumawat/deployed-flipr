...
import { addUser } from '../services/operations/adminApi';
import { useNavigate } from 'react-router-dom';

const AddUserModal = ({ isOpen, onClose,selectedDatabase, onCreateUser }) => {
    ...
    const handleCreateUser = () => {
        dispatch(addUser(email,selectedDatabase,token,navigate))
        setEmail('');
        navigate("/");
        onClose();
    };
